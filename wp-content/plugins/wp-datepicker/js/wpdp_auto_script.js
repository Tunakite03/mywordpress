	...
	jQuery(document).ready(function($){
		...
		if($('.wpcf7-form-control.wpcf7-repeater-add').length>0){
			$('.wpcf7-form-control.wpcf7-repeater-add').on('click', function(){
				wpdp_refresh_2267(jQuery, true);
			});
		}
		
	
});
var wpdp_refresh_first_2267 = 'yes';
var wpdp_intv_2267;
var wpdp_counter_2267 = 0;
var wpdp_month_array_2267 = [];
var wpdp_dateFormat = "mm/dd/yy";
var wpdp_defaultDate = "";
function wpdp_refresh_2267($, force){
				if(typeof $.datepicker!='undefined' && typeof $.datepicker.regional["en-GB"]!='undefined'){
					
				wpdp_month_array_2267 = $.datepicker.regional["en-GB"].monthNames;
				...
				//force = true;
								if(wpdp_refresh_first_2267 == 'yes' || force){
					...
					$.each($("#date-field"), function(wp_si, wp_sv){
						if($(this).val()!=''){
							$(this).attr('data-default-val', $(this).val());
								...
								if(wpdp_counter_2267 > 2)
				clearInterval(wpdp_intv_2267);
...
setTimeout(function(){ 
	 ...
	 $.each($("#date-field"), function(){
		...
		if(expected_stamp != undefined && expected_stamp!=''){ $(this).datepicker().datepicker('setDate', expected_stamp_str); }		
				...
				$(".calendar-field").attr('readonly', 'readonly');
...
setTimeout(function(){ 
	...
	wpdp_intv_2267 = setInterval(function(){
		wpdp_counter_2267++;
		wpdp_refresh_2267(jQuery, false);
